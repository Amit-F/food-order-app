      ...
      <div className='mt-8 '>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full mt-8 text-end'>
            <button onClick={()=>navigateAndScroll('/orders')} className='px-16 py-3 text-sm text-white bg-black'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
